	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'matt':
				...
				addOffset("singUP", -1, 35);
				addOffset("singRIGHT", 8, -5);
				addOffset("singLEFT", 106, -20);
				addOffset("singDOWN", -22, -9);
				playAnim('idle');
			...
			case 'mattold':
				...
				animation.addByPrefix('singLEFT', 'matt left note', 24, false);
				animation.addByPrefix('singRIGHT', 'matt right note', 24, false);
				addOffset("singUP", -9, 67);
				addOffset("singRIGHT", 0, 37);
				addOffset("singLEFT", 115, 23);
				addOffset("singDOWN", 2, -35);
				playAnim('idle');
