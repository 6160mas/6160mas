...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'light-it-up':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/light-it-up/lightDialogue'));
			case 'ruckus':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/ruckus/ruckusDialogue'));
			case 'target-practice':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/target-practice/targetDialogue'));
			case 'sporting':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/sporting/sportingDialogue'));
			case 'boxing-match':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/boxing-match/boxingDialogue'));
			case 'fisticuffs':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/fisticuffs/fisticuffsDialogue'));
			case 'wind-up':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/wind-up/windupDialogue'));
			case 'deathmatch':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/deathmatch/deathmatchDialogue'));
			case 'king-hit':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/king-hit/kinghitDialogue'));	
		}
		...
		healthBar.createFilledBar(0xFFFF8B00, 0xFF30AFD0);
		// healthBar
		add(healthBar);
		...
		if (SONG.song.toLowerCase() == 'final-showdown') 
{
	...
	*/
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'tko')
		{
			if (curStep == 224) //start
			{
				var uno:FlxSprite = new FlxSprite().loadGraphic(Paths.image('uno'));
			...
			if (curStep == 232)
			{
				var dos:FlxSprite = new FlxSprite().loadGraphic(Paths.image('dos'));
			...
			if (curStep == 240)
			{
				var tres:FlxSprite = new FlxSprite().loadGraphic(Paths.image('tres'));
			...
			if (curStep == 248)
			{
				var gooo:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cuatro'));
			...
			if (curStep == 256) //start of beat stuff
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 280)
			...
			if (curStep == 488) //beat stuff ending lol
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 496) //special animation
			{
				dad.playAnim('snep', true);
				FlxTween.tween(FlxG.camera, {zoom: 1.4}, 0.5, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 512) //first drop
			{
				shakeCam = true;
				FlxTween.tween(FlxG.camera, {zoom: 0.8}, 5.96, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 640) //start beat stuff agin
			{
				shakeCam = false;
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
			...
			if (curStep == 744) //end of beat shit again 
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 768) //blammed break beat
			{
				FlxTween.tween(FlxG.camera, {zoom: 0.72}, 11.92, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 832)
			...
			if (curStep == 896) //camera rotatessssss
			{
				FlxTween.tween(camHUD, {angle: 3}, 0.2, {
			ease: FlxEase.expoOut		
				});
			}
			if (curStep == 904)
			...
			if (curStep == 928) //camera rotatessssss 2
			{
				FlxTween.tween(camHUD, {angle: -3}, 0.2, {
			ease: FlxEase.expoOut		
				});
			...
			if (curStep == 1024) //back to blame
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
				FlxTween.tween(camHUD, {angle: 0}, 0.2, {
			ease: FlxEase.expoOut		
				});
			}
			if (curStep == 1040)
			{
				FlxTween.tween(FlxG.camera, {zoom: 0.82}, 0.1, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1048)
			...
			{
				shakeCam = false;
					FlxTween.tween(FlxG.camera, {zoom: 0.7}, 2.98, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1344)
			{
					FlxTween.tween(FlxG.camera, {zoom: 0.8}, 2.98, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1408)
			{
				FlxTween.tween(camHUD, {angle: -3}, 1.49, {
			ease: FlxEase.expoOut		
				});
					FlxTween.tween(FlxG.camera, {zoom: 0.9}, 1.49, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1439)
			...
			ease: FlxEase.expoOut		
					...
					FlxTween.tween(FlxG.camera, {zoom: 1}, 1.49, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1472)
			...
			ease: FlxEase.expoOut		
				...
				dad.playAnim('tired');
					FlxTween.tween(FlxG.camera, {zoom: 1.1}, 2.24, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1504)
			...
			if (curStep == 1520)
			{
				dad.playAnim('transform');
					FlxTween.tween(FlxG.camera, {zoom: 1.45}, 0.5, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1536)
			...
			if (curStep == 1568)
			{
					FlxTween.tween(FlxG.camera, {zoom: 0.7}, 1.49, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1632)
			...
			if (curStep == 1976)
			{
				FlxTween.tween(FlxG.camera, {zoom: 0.8}, 0.1, {
            ease: FlxEase.expoOut
				});
			}
			if (curStep == 1978)
			...
			if (curStep == 2048)
			{
				FlxTween.tween(camHUD, {angle: 180}, 2.99, {
			ease: FlxEase.expoOut		
				});
			}
		}

		if (SONG.song.toLowerCase() == 'boxing-match')
		{
			if (curStep == 1760) //start
			{
				var uno:FlxSprite = new FlxSprite().loadGraphic(Paths.image('uno'));
				uno.scrollFactor.set();
				uno.updateHitbox();
			...
			if (curStep == 1792) //start of beat stuff
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
		...
		if (SONG.song.toLowerCase() == 'fisticuffs')
		{
			if (curStep == 240) //start
			{
				var uno:FlxSprite = new FlxSprite().loadGraphic(Paths.image('uno'));
				uno.scrollFactor.set();
				uno.updateHitbox();
		...
		if (SONG.song.toLowerCase() == 'deathmatch')
		{
			...
			if (curStep == 576) //start of beat stuff
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.12}, 0.1, {
            ease: FlxEase.expoOut
				});
