...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('ModderFunkersLogo'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 12:
				deleteCoolText();
			// credTextShit.visible = false;
			// credTextShit.text = "WII FUNKIN";
			// credTextShit.screenCenter();
			case 13:
				addMoreText('WII FUNKIN');
			// credTextShit.visible = true;
			case 14:
				addMoreText('VS');
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('MATT'); // credTextShit.text += '\nFunkin';
			case 16:
				skipIntro();
		}
	}
