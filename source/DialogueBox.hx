...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='light-it-up' || PlayState.SONG.song.toLowerCase()=='ruckus' || PlayState.SONG.song.toLowerCase()=='target-practice')
		{
		...
		if (PlayState.curStage != 'swordarena' && PlayState.curStage != 'boxing' && PlayState.curStage != 'boxarena' && PlayState.curStage != 'boxFC' && PlayState.curStage != 'boxDM' && PlayState.curStage != 'boxWU' && PlayState.curStage != 'boxKH' && PlayState.curStage != 'volcano' && PlayState.curStage != 'volcano_gf')
		{
